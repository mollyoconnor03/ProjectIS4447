...
import { CategoryContext, Target, TripContext } from '../../_layout';
...
export default function EditTarget() {
  ...
  const save = async () => {
    ...
    await db
      .update(targetsTable)
      .set({ label: label.trim(), period, targetValue: val, categoryId, tripId })
      .where(eq(targetsTable.id, Number(id)));
    router.back();
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScreenHeader title="Edit Target" subtitle={label} />
